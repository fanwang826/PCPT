...
if __name__ == '__main__':
    ...
    parser.add_argument('--tpt', action='store_true', default= True, help='run pseudo-labeling')
    ...
    parser.add_argument('--output', type=str, default='./Few_shot_datasets/Final_Other/test')
    ...
    for i in range(1):
        # args.t = i
        args.name = names
        args.out_file = open(osp.join(args.output, args.name+'_pseudo_labeling.txt'), 'w')
